...
export const metadata: Metadata = {
  ...
  description:
    'Get in touch with Optivantage Technologies for AI training (Copilot 365, ChatGPT, ISO 42001), IT infrastructure (Cisco, Fortinet, Vertiv), or IT equipment rental enquiries. Pan-India and online. Response within 24 hours.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Enquire about AI training, IT infrastructure, or equipment rentals. Pan-India and online. Response within 24 hours.',
