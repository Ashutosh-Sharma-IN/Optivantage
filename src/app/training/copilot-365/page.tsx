...
const painPoints = [
  ...
  },
  {
    ...
    modules: [
      "Advanced Prompting with CRAFT",
      "Role Playbooks",
      "Building Your Personal Copilot System",
    ],
  },
  {
    id: "privacy",
    ...
    modules: [
      "AI Ethics & The SANCTITY Method",
      "Claude for Office — When to Use Claude Alongside Copilot",
    ],
  },
  {
    id: "workflow",
    ...
    modules: [
      ...
      "Copilot as Your Workflow Manager",
      "Your 90-Day Copilot Action Plan",
    ],
  },
  {
    id: "overwhelmed",
    emoji: "😵",
    label:
      "The tool feels overwhelming — too many features, no clear starting point",
    modules: [
      "What Is Copilot 365 — and Why Most Users Miss 80% of It",
      "Live Prompt Lab #1",
      "The CRAFT Framework",
    ],
  },
...
const weekends = [
  {
    ...
    subtitle:
      "Understand what Copilot is, what it's not, and start getting real results from Day 1.",
    days: [
      {
        ...
        modules: [
          {
            title: "What Is Copilot 365 — and Why Most Users Miss 80% of It",
            duration: "45 min",
          },
          {
            title: "Live Prompt Lab #1 — Your First 10 Copilot Prompts",
            duration: "60 min",
          },
          {
            title: "The CRAFT Framework — Copilot's 5-Part Prompting System",
            duration: "45 min",
          },
        ],
      },
      {
        ...
        modules: [
          {
            title: "Copilot in Outlook — Emails, Summaries & Smart Replies",
            duration: "45 min",
          },
          {
            title: "Copilot in Teams — Meeting Summaries & Action Items",
            duration: "45 min",
          },
          {
            title: "Copilot in Word — Documents, Drafts & Rewrites",
            duration: "60 min",
          },
        ],
      },
  ...
  },
  {
    ...
    subtitle:
      "Unlock Copilot's most powerful productivity features across your daily Microsoft 365 tools.",
    days: [
      {
        label: "Day 1 — Saturday",
        duration: "2.5 hrs",
        modules: [
          {
            title:
              "Copilot in Excel — Data Analysis, Formulas & Insights Without Code",
            duration: "75 min",
          },
          {
            title: "Copilot in PowerPoint — Slides from Scratch in Minutes",
            duration: "75 min",
          },
        ],
      },
      {
        ...
        modules: [
          {
            title: "Advanced Prompting with CRAFT — Context, Tone & Iteration",
            duration: "60 min",
          },
          {
            title: "Image Creation with AI — The FACE Method (25 min segment)",
            duration: "25 min",
          },
          {
            title: "Copilot in OneNote & Loop — Your AI Knowledge Hub",
            duration: "65 min",
          },
        ],
      },
  ...
  },
  {
    ...
    subtitle:
      "Move beyond single prompts. Build Copilot into your workflows and let it work for you.",
    days: [
      {
        label: "Day 1 — Saturday",
        duration: "2.5 hrs",
        modules: [
          {
            title:
              "Copilot as Your Research Analyst — Deep Research & Summarisation",
            duration: "75 min",
          },
          {
            title:
              "Copilot as Your Workflow Manager — Recurring Tasks & Handoffs",
            duration: "75 min",
          },
        ],
      },
      {
        ...
        modules: [
          {
            title: "Power Automate + Copilot — No-Code Workflow Automation",
            duration: "75 min",
          },
          {
            title:
              "Building Your Personal Copilot System — Role Playbooks & Templates",
            duration: "75 min",
          },
        ],
      },
  ...
  },
  {
    ...
    subtitle:
      "Use AI responsibly, add Claude as a Copilot companion, and lock in your next 90 days.",
    days: [
      {
        label: "Day 1 — Saturday",
        duration: "2.5 hrs",
        modules: [
          {
            title: "Claude for Office — When to Use Claude Alongside Copilot",
            duration: "85 min",
          },
          {
            title:
              "AI Ethics & The SANCTITY Method — Protecting Sensitive Data",
            duration: "65 min",
          },
        ],
      },
      {
        ...
        modules: [
          {
            title: "Live Prompt Lab #2 — Showcase & Peer Review",
            duration: "60 min",
          },
...
const audiences = [
  {
    ...
    desc: "Managers, analysts, and consultants who want to do more with less time.",
  },
  {
    icon: Building2,
    label: "Team Leaders & Managers",
    desc: "Lead more effectively — summarise, delegate, and communicate at speed.",
  },
  {
    icon: BookOpen,
    label: "HR & L&D Professionals",
    desc: "Manage people, training, and documentation more efficiently with AI.",
  },
  {
    icon: FileText,
    label: "Finance & Operations",
    desc: "Faster data analysis, smarter reporting, and leaner workflows.",
  },
  {
    icon: MessageSquare,
    label: "Sales & Marketing Teams",
    desc: "Draft proposals, emails, and content faster — and more persuasively.",
  },
  {
    icon: Monitor,
    label: "IT & Project Managers",
    desc: "Document, plan, and communicate technical projects with AI support.",
  },
  {
    icon: Users,
    label: "Executive Assistants",
    desc: "Master meeting notes, email management, and executive briefing documents.",
  },
  {
    icon: Star,
    label: "Anyone on Microsoft 365",
    desc: "If you have a Microsoft 365 licence, this course pays for itself in week one.",
  },
];
...
const faqs = [
  ...
  {
    q: "Is enterprise / face-to-face training available?",
    a: "Yes — we offer bespoke in-person and weekday programmes for corporate teams. Use the Enterprise Training enquiry option in the form below.",
  },
];
...
const certificates = [
  ...
  {
    title: "AI+ Executive™",
    img: "/certificates/Certificate_AI_Executives.png",
  },
  {
    title: "AI+ Prompt Engineer™",
    img: "/certificates/Certificate_AI_prompt_Engineer.png",
  },
  { title: "AI+ Ethics™", img: "/certificates/certificate_AI_Ethics.png" },
  {
    title: "AI+ Chief AI Officer™",
    img: "/certificates/Certificate_Chief_AI_Officer.png",
  },
...
export default function Copilot365Page() {
  ...
  const [enquiryType, setEnquiryType] = useState<"individual" | "enterprise">(
    "individual",
  );
  ...
  const highlightedModules =
    selectedPains.length > 0
      ? Array.from(
          new Set(
            selectedPains.flatMap(
              (id) => painPoints.find((p) => p.id === id)?.modules ?? [],
            ),
          ),
        )
      : [];
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append(
      "_subject",
      `Copilot 365 Course Enquiry — ${enquiryType === "enterprise" ? "Enterprise/In-Person" : "Individual/Virtual"}`,
    );
    try {
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto text-center">
        ...
        <div className="flex justify-center items-center gap-4 mb-8 flex-wrap">
          <div className="bg-white rounded-xl px-5 py-3 flex items-center gap-3 shadow-sm">
            ...
            <Image
              src="/platforms/copilot_preview.jpg"
        ...
        <div className="inline-flex items-center gap-2 bg-brand/10 border border-brand/30 rounded-full px-4 py-2 mb-6">
          <span className="text-brand text-sm font-semibold">
            Live Online · 4 Weekends · 20 Hours
          </span>
        </div>
        ...
        <p className="text-xl text-text-muted max-w-3xl mx-auto mb-4 leading-relaxed">
          A practitioner-led course for working professionals who have Microsoft
          Copilot — and want to actually use it to save 5+ hours a week.
        </p>
        <p className="text-base text-brand font-semibold mb-10">
          Taught by an accredited Microsoft & Google AI trainer. Small cohorts.
          Live sessions. Role-specific playbooks.
        </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center items-center gap-5">
            {certLogos.map((c) => (
              <div
                key={c.name}
                className="bg-white rounded-xl px-4 py-3 flex items-center justify-center h-16 shadow-sm"
              >
                <Image
                  src={c.logo}
                  alt={c.name}
      ...
      <section className="py-16 px-4 bg-navy-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            You Have Copilot. But Are You Actually Using It?
          </h2>
          <div className="grid md:grid-cols-3 gap-6 text-left mt-10">
            {[
              {
                stat: "68%",
                text: "of Microsoft Copilot users say they don't know how to prompt it effectively.",
              },
              {
                stat: "5 hrs",
                text: "average time saved per week by professionals who learn structured Copilot workflows.",
              },
              {
                stat: "Most",
                text: "Copilot training is generic, product-demo style — not built around your actual job.",
              },
            ].map(({ stat, text }) => (
              <div
                key={stat}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              What's Your Copilot Challenge?
            </h2>
            <p className="text-text-muted max-w-xl mx-auto">
              Select every statement that resonates. We'll show you exactly
              which modules address it.
            </p>
          </div>
            ...
            {painPoints.map((pain) => {
              ...
              return (
                ...
                >
                  ...
                  {selected && (
                    <CheckCircle2
                      className="text-brand flex-shrink-0 ml-auto mt-0.5"
                      size={18}
                    />
                  )}
                </button>
          ...
          {selectedPains.length === 0 && (
            <p className="text-center text-gray-600 text-sm">
              Select one or more challenges above to see your personalised
              course highlights.
            </p>
          )}
        </div>
      ...
      <section className="py-20 px-4 bg-navy-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-text-muted mb-12 max-w-2xl mx-auto">
            The 5-part prompting system you'll use in every Copilot interaction
            — and keep using long after the course ends.
          </p>
          ...
          <p className="text-text-muted text-sm mt-8 max-w-xl mx-auto">
            CRAFT replaces guesswork with a repeatable formula. You'll master it
            in Weekend 1 and apply it across every session that follows.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              Not for developers. Not for IT teams. For the people who use
              Microsoft 365 every single day.
            </p>
          </div>
      ...
      <section id="curriculum" className="py-20 px-4 bg-navy-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              4 Weekends. 20 Hours. 22 Modules.
            </h2>
            <p className="text-text-muted max-w-2xl mx-auto">
              Each weekend builds on the last — from foundations to full
          ...
          <div className="space-y-4">
            {weekends.map((weekend, wIdx) => (
              ...
              >
                <button
                  onClick={() =>
                    setOpenWeekend(openWeekend === wIdx ? null : wIdx)
                  }
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {weekend.days.map((day) => (
                        <div key={day.label}>
                          ...
                          <ul className="space-y-2">
                            {day.modules.map((mod) => {
                              const isHighlighted = highlightedModules.includes(
                                mod.title,
                              );
                              return (
                                <li
                                ...
                                >
                                  <CheckCircle
                                    className={`h-4 w-4 mt-0.5 flex-shrink-0 ${isHighlighted ? "text-brand" : "text-brand/50"}`}
                                  />
                                  <div>
                                    <span
                                      className={`text-sm ${isHighlighted ? "text-white font-medium" : "text-white"}`}
                                    >
                                      {mod.title}
                                    </span>
                                    {isHighlighted && (
      ...
      <section className="py-20 px-4 bg-navy-900">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              We also deliver bespoke Copilot 365 programmes for corporate teams
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-navy-800 border border-white/10 rounded-2xl p-8 hover:border-brand/30 transition-colors">
              ...
              <a
                href="#enquire-enterprise"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand hover:bg-brand-hover text-white text-sm font-semibold rounded-lg transition-all"
              >
            ...
            <div className="bg-navy-800 border border-white/10 rounded-2xl p-8 hover:border-brand/30 transition-colors">
              ...
              <a
                href="#enquire-enterprise"
                className="inline-flex items-center gap-2 px-5 py-2.5 border border-brand/50 text-brand hover:bg-brand/10 text-sm font-semibold rounded-lg transition-all"
              >
          ...
          <p className="text-center text-sm text-text-muted mt-8">
            Group rates apply. No pricing shown — we discuss scope and fit on a
            short call.
          </p>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-br from-navy-900 to-navy-800 border border-brand/20 rounded-3xl p-10 md:p-14">
            <div className="flex flex-col md:flex-row gap-10 items-center">
              <div className="flex-shrink-0">
                <div className="h-44 w-44 rounded-2xl bg-brand/10 border-2 border-brand/30 shadow-xl flex items-center justify-center">
                  <span className="text-brand text-4xl font-bold">OT</span>
                </div>
              </div>
              <div>
                ...
                <p className="text-brand font-semibold text-sm mb-4">
                  Founder, Optivantage Technologies
                </p>
                <p className="text-text-muted text-sm leading-relaxed mb-6">
                  25 years running mission-critical IT operations for BT Global,
                  Telstra, and SITA. Led teams of 2,000+ across 4 continents.
                  Trained 1,000+ professionals in AI across enterprises
                  including BIAL, Kotak Mahindra Bank, Hexaware, Infogain, and
                  MSME India.
                </p>
            ...
            <div className="mt-10 pt-8 border-t border-white/10">
              ...
              <div className="flex flex-wrap justify-center items-center gap-6">
                {clients.map((client) => (
                  <div
                    key={client.name}
                    className="bg-white rounded-xl p-3 flex items-center justify-center h-20 shadow-sm"
                  >
                    <Image
                      src={client.logo}
                      alt={client.name}
      ...
      <section className="py-20 px-4 bg-navy-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              Participants receive an Optivantage completion certificate. We
              also facilitate AI+ certification programmes through our
              accredited partners. Click any certificate to enlarge.
            </p>
          </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-text-muted">
              No pricing shown — we discuss cohort dates, group rates, and fit
              on a short call first.
            </p>
          </div>

          {/* Toggle: Individual vs Enterprise */}
          <div
            id="enquire-enterprise"
            ...
            <div className="mb-8 p-6 bg-green-500/10 border border-green-500/30 rounded-xl flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-green-200 text-sm">
                  We'll be in touch within 24 hours with cohort dates and next
                  steps.
                </p>
              </div>
            </div>
          ...
          >
            ...
            {enquiryType === "individual" ? (
              <div>
                <label className="block text-sm text-text-muted mb-2">
                  Are you enquiring for yourself or a small group?
                </label>
                <select
                  name="group_size"
            ...
            <div>
              <label className="block text-sm text-text-muted mb-2">
                Anything specific you'd like to cover or ask?
              </label>
              <textarea
                name="message"
                rows={3}
            ...
            <input
              type="hidden"
              name="course"
              value="Microsoft Copilot 365 — 4 Weekend Live Course"
            />
      ...
      <section className="py-14 px-4 bg-navy-800 border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-text-muted mb-2 text-sm">
            Looking for broader AI transformation for your enterprise?
          </p>
          <h3 className="text-2xl font-bold text-white mb-4">
            Beyond Copilot — Full AI Training & Advisory
          </h3>
          <p className="text-text-muted mb-6 max-w-xl mx-auto text-sm">
            We deliver custom AI and Copilot training programmes, AI strategy,
            and ISO 42001 governance for enterprise teams.
          </p>
          <Link
