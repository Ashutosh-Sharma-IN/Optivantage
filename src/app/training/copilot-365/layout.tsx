...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Copilot 365 workshop', 'Microsoft AI training India', 'M365 Copilot training',
    'AI productivity training', 'Copilot prompting course', 'CRAFT prompting framework',
    'Microsoft Copilot certification', 'AI training for working professionals',
    'Microsoft Copilot for business', 'enterprise Copilot training',
    'Copilot in Word Excel PowerPoint Teams', 'AI upskilling course India',
  ],
  ...
  twitter: {
    ...
    description: 'Live Copilot 365 training for working professionals. 20 hrs · 22 modules · Certificate. Certified Microsoft AI trainer.',
...
const courseSchema = {
  ...
  hasCourseInstance: [
    {
      ...
      description: 'Live online sessions across 4 weekends (Saturday & Sunday, 2.5 hrs each)',
      instructor: { '@id': `${BASE_URL}/about#ashutosh-sharma` },
    },
    {
      '@type': 'CourseInstance',
      courseMode: 'onsite',
      name: 'In-Person Enterprise Training',
      description: 'Bespoke in-person training at your office. Weekday and weekend formats available.',
      instructor: { '@id': `${BASE_URL}/about#ashutosh-sharma` },
    },
  ],
  offers: {
  ...
  keywords: [
    'Microsoft Copilot 365', 'Copilot training', 'AI productivity',
    'CRAFT framework', 'prompt engineering', 'M365 AI', 'enterprise AI training',
  ],
};
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ashutosh Sharma, Founder of Optivantage Technologies. He is a certified Microsoft AI trainer, Google Cloud Digital Leader, ISO/IEC 42001 Lead Implementer, and has trained 1,000+ professionals across enterprises including BIAL, Kotak Mahindra Bank, Hexaware, Infogain, and MSME India.',
      },
    },
  ],
};

export default function Copilot365Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <Script
