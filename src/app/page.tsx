...
export const metadata: Metadata = {
  title:
    "Optivantage | AI Training, Automation, IT Infrastructure & Equipment | India",
  description:
    "Optivantage Technologies — founder-led specialist in AI training (Copilot 365, ChatGPT, ISO 42001), AI automation (Make.com, agentic AI), IT infrastructure (Cisco, Fortinet, Vertiv), and IT equipment supply & rentals. 25 years enterprise IT expertise at BT, Telstra, SITA. 1,000+ professionals trained. Pan-India and online.",
  keywords: [
    "AI training India",
    "AI consulting Delhi",
  ...
  authors: [
    { name: "Optivantage Technologies", url: "https://www.optivantage.in" },
  ],
  creator: "Optivantage Technologies",
  ...
  openGraph: {
    title:
      "AI Training & Consulting India | Microsoft Copilot, ISO 42001 | Optivantage",
    description:
      "Expert AI training & consulting in India. Microsoft Copilot 365, ChatGPT, ISO 42001 governance. 25+ years enterprise IT experience. Pan-India and online. International AI training engagements available.",
    ...
    images: [
      {
        ...
        width: 400,
        height: 120,
        alt: "Optivantage Technologies — AI Training, IT Infrastructure & Equipment",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Expert AI training & consulting in India. Microsoft Copilot 365, ChatGPT, ISO 42001 governance. 25+ years enterprise IT experience.",
    images: ["/logo.png"],
...
const homepageFaqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Optivantage was built on 25+ years of enterprise IT operations experience at BT (telecom), Telstra (telecom), and SITA (aviation IT). The firm delivers AI training tailored to the workflows, compliance requirements, and terminology of telecom, aviation, and airport operations teams.",
      },
    },
    {
      "@type": "Question",
...
const services = [
  ...
  },
  {
    ...
    href: "/ai-automation",
    description:
      "Production-grade Make.com pipelines — B2B sales intelligence, self-healing agents, document processing, support triage, voice AI, and agentic workflows delivered end-to-end.",
    features: [
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg text-text-muted mb-10 leading-relaxed max-w-3xl mx-auto">
            Optivantage is a founder-led specialist for Indian enterprises that
            need practical AI — not slide decks. We train your teams on Copilot,
            ChatGPT, and ISO 42001 governance. We build production automation
            with Make.com and agentic AI. We design and deliver IT
            infrastructure. We supply and rent enterprise hardware. Our founders
            bring 25 years at BT, Telstra, and SITA — 1,000+ professionals
            trained.
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20 pt-10 border-t border-white/10">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-text-muted mt-1">
              Trained in AI across Enterprises
            </div>
          </div>
          <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              We made a deliberate choice to go deep, not wide. Every engagement
              is founder-led, not delegated to junior consultants.
            </p>
          </div>
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <Link
                    href={service.href}
                    className="inline-flex items-center text-brand font-semibold hover:underline mt-auto"
                  >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive AI training designed to answer your most pressing
              questions about AI implementation in India
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/ai-training-guide" className="group">
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <p className="text-gray-600 mb-4">
                  Everything you need to know about AI training in India - from
                  costs to certifications, programs to career opportunities.
                </p>
            ...
            <Link href="/microsoft-copilot-training" className="group">
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <p className="text-gray-600 mb-4">
                  Master AI-powered productivity tools. Learn Copilot
                  integration across Microsoft 365 for enhanced workflow
                  automation.
                </p>
            ...
            <Link href="/iso-42001-training" className="group">
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <p className="text-gray-600 mb-4">
                  Learn AI ethics, risk management, and compliance frameworks
      ...
      <section className="py-20 bg-navy-800 px-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              We're not consultants who've only read the playbook. We've lived
              it — running operations for global enterprises across telecom,
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-navy-900 p-8 rounded-xl border border-white/5 hover:border-brand/50 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">
                AI From Training to Governance
              </h3>
              <p className="text-text-muted">
                We cover the full AI journey — from building literacy across
                your teams to ISO/IEC 42001 AI governance. Certified Microsoft &
                Google AI trainer. 1000+ professionals trained.
              </p>
            </div>
            ...
            <div className="bg-navy-900 p-8 rounded-xl border border-white/5 hover:border-brand/50 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">
                Infrastructure Built to Enterprise Standard
              </h3>
              <p className="text-text-muted">
                Cisco Registered Partner. Vertiv Authorised Reseller. Fortinet &
                Palo Alto Networks. We design and build infrastructure that runs
                — from passive cabling to network security.
              </p>
            </div>
            ...
            <div className="bg-navy-900 p-8 rounded-xl border border-white/5 hover:border-brand/50 transition-colors">
              ...
              <p className="text-text-muted">
                Four focused services — not twenty. Every engagement is led by
                the founder, backed by 25 years of running enterprise IT for BT,
                Telstra, and SITA. You get the expert, not a junior.
              </p>
            </div>
          </div>
        </div>
