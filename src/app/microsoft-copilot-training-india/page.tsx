...
export const metadata: Metadata = {
  title:
    "Microsoft Copilot 365 Training India | Enterprise Copilot Training | Optivantage",
  description:
    "Expert Microsoft Copilot 365 training for enterprise teams across India. In-person and online. Banking, aviation, telecom, MSME. 1,000+ professionals trained. Founder-led. Pan-India and online.",
  keywords: [
  ...
  alternates: {
    canonical: "https://www.optivantage.in/microsoft-copilot-training-india",
  },
  openGraph: {
    title: "Microsoft Copilot 365 Training India | Optivantage Technologies",
    description:
      "Expert Copilot 365 training for enterprise teams across India. 1,000+ professionals trained. Banking, aviation, telecom. In-person and online.",
  ...
  "@graph": [
    {
      "@type": "Course",
      "@id":
        "https://www.optivantage.in/microsoft-copilot-training-india#course",
      name: "Microsoft Copilot 365 Training for Enterprise Teams",
      provider: {
        "@id": "https://www.optivantage.in/#organization",
      },
      description:
        "Expert Microsoft Copilot 365 training delivered across India for enterprise teams. Covers Copilot in Word, Excel, PowerPoint, Outlook, Teams, and advanced prompting. Customised by industry and role.",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Optivantage Technologies delivers Microsoft Copilot 365 training for enterprise teams across India. The firm has trained 1,000+ professionals including teams at Kotak Mahindra Bank, BIAL (Bengaluru International Airport), Hexaware, and Infogain. Training is founder-led by certified Microsoft AI trainers and is delivered in-person across India and online.",
          },
        },
        {
          "@type": "Question",
    ...
    <main className="min-h-screen">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-gray-300 mb-6 leading-relaxed">
            Practical, role-specific Copilot 365 training for enterprise teams.
            Not a demo — a real programme that changes how your people work.
            1,000+ professionals trained across banking, aviation, IT services,
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 mb-10 max-w-2xl">
          After training, participants leave with practical skills they can
          apply the same day — not concepts to look up later.
        </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-white mb-8">
          Copilot Applications Covered
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            {
              app: "Copilot in Word",
              skill: "Draft, edit, summarise, reformat documents",
            },
            {
              app: "Copilot in Excel",
              skill: "Analyse data, generate formulas, spot trends",
            },
            {
              app: "Copilot in PowerPoint",
              skill: "Create slides from a prompt or document",
            },
            {
              app: "Copilot in Outlook",
              skill: "Draft emails, summarise threads, prep for meetings",
            },
            {
              app: "Copilot in Teams",
              skill: "Meeting summaries, action items, catch-up",
            },
            {
              app: "Microsoft Copilot Chat",
              skill: "Research, drafting, problem-solving across M365",
            },
          ].map((item) => (
            <div
              key={item.app}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-gray-300 mb-6">
            Generic AI training fails because the prompts, use cases, and
            examples don't match participants' actual work. We build
            industry-specific examples and prompting guides into every
            programme.
          </p>
          <div className="grid md:grid-cols-2 gap-4">
            {[
              {
                ...
                eg: "Credit analysis, regulatory filing, client communication",
              },
              {
                industry: "Aviation & Airports",
                eg: "Operational reports, MRO docs, crew briefings",
              },
              {
                industry: "Telecom & IT Services",
                eg: "Incident RCA, proposals, service reports",
              },
              {
                industry: "MSME & General Enterprise",
                eg: "Sales decks, client proposals, weekly reports",
              },
            ].map((item) => (
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-gradient-to-r from-brand/20 to-orange-400/10 border border-brand/30 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Ready to Run Copilot Training for Your Team?
          </h2>
          <p className="text-gray-300 mb-8 max-w-xl mx-auto">
            Share your team size, industry, and any specific focus areas. We'll
            propose the right format and timeline.
          </p>
