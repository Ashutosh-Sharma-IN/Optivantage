...
export const metadata: Metadata = {
  ...
  description:
    "Practical insights on enterprise AI adoption, Microsoft Copilot 365, ISO/IEC 42001 AI governance, network infrastructure, SD-WAN, structured cabling, and IT equipment. Written by the Optivantage team — certified Microsoft AI trainers and ISO 42001 Lead Implementers.",
  keywords: [
    "AI blog India",
    ...
    "SD-WAN explainer",
    "AI for business blog India",
    "Gen AI insights",
    "AI upskilling articles",
  ],
  alternates: { canonical: "https://www.optivantage.in/blog" },
  openGraph: {
    title:
      "Blog | AI Training, IT Infrastructure & Enterprise Tech | Optivantage",
    description:
      "Practical AI and IT insights from 25 years of enterprise experience. Copilot 365, ISO 42001, SD-WAN, network infrastructure and more.",
    ...
    <main>
      ...
      <section className="pt-32 pb-16 px-4 bg-navy-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-text-muted">
            Practical thinking on AI adoption, IT infrastructure, and enterprise
            technology — written from the field, not the whiteboard.
          </p>
        </div>
      </section>
      ...
      {blogPosts.length === 0 ? (
        ...
        <section className="py-32 px-4 bg-navy-800 text-center">
          ...
          <p className="text-text-muted text-sm">
            We publish once a week on AI, infrastructure, and enterprise IT.
          </p>
        </section>
      ) : (
        <>
            ...
            <section className="py-16 px-4 bg-navy-800">
              <div className="max-w-5xl mx-auto">
                ...
                <Link
                  ...
                  className="group block bg-navy-900 rounded-2xl border border-white/5 hover:border-brand/50 transition-all overflow-hidden"
                >
                  <div className="p-10">
                    <div className="flex flex-wrap items-center gap-3 mb-5">
                      <span
                        className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border ${categoryColors[featured.category]}`}
                      >
                  ...
                  {rest.map((post) => (
                    ...
                    >
                      <div className="flex flex-wrap items-center gap-2 mb-4">
                        <span
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold border ${categoryColors[post.category]}`}
                        >
      ...
      <section className="py-16 px-4 bg-navy-800 text-center">
        ...
        <p className="text-text-muted mb-8 max-w-xl mx-auto">
          We're always happy to have a real conversation about AI,
          infrastructure, or IT strategy.
        </p>
        <Link
          href="/contact"
          className="inline-block px-8 py-3 bg-brand hover:bg-brand-hover text-white font-semibold rounded-lg transition-all"
        >
          Get in Touch
        </Link>
      </section>
