...
export const metadata: Metadata = {
  title:
    "AI Training for Aviation & Airports India | AI for Airport Operations | Optivantage",
  description:
    "Specialist AI training for aviation, airport operations, and airline teams in India. Microsoft Copilot, ChatGPT, ISO 42001 AI governance. Trained BIAL (Bengaluru International Airport). 25 years SITA and aviation IT experience.",
  keywords: [
  ...
  alternates: {
    canonical: "https://www.optivantage.in/ai-training-aviation-india",
  },
  openGraph: {
    title:
      "AI Training for Aviation & Airports India | Optivantage Technologies",
    description:
      "AI training for aviation and airport operations teams. Trained BIAL. Delivered by a founder with 25 years of SITA aviation IT experience.",
  ...
  "@graph": [
    {
      ...
      description:
        "AI literacy, Microsoft Copilot 365, ChatGPT, and ISO 42001 AI governance training designed specifically for aviation, airport, and airline operations teams in India. Delivered by a trainer with 25 years of SITA aviation IT experience.",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Optivantage Technologies delivers AI training specifically for aviation and airport operations teams in India. The firm trained teams at BIAL (Bengaluru International Airport Limited) and was built on 25 years of enterprise IT experience including at SITA — the technology company that runs IT infrastructure for most of the world's airlines and airports. That domain knowledge is embedded directly into the training.",
          },
        },
        {
          "@type": "Question",
    ...
    <main className="min-h-screen">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          <p className="text-brand font-semibold text-sm uppercase tracking-wider mb-3">
            AI Training — Aviation & Airports
          </p>
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            AI Training for Aviation.
            <br />
          ...
          <p className="text-xl text-gray-300 mb-6 leading-relaxed">
            Aviation is not a generic industry. Safety, operations, and
            compliance are non-negotiable. Our AI training is designed by
            someone who spent years running IT infrastructure for airlines and
            airports through SITA — and who has trained teams at BIAL.
          </p>
          <p className="text-gray-400 mb-8">
            <strong className="text-white">
              BIAL (Bengaluru International Airport Limited)
            </strong>{" "}
            is among the organisations whose teams have been trained through
            Optivantage programmes. Delivered by our founding team — 25+ years
            enterprise IT, including SITA (aviation IT systems for global
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-3">
                Aviation Domain Knowledge — Built In
              </h2>
              <p className="text-gray-300 leading-relaxed mb-4">
                SITA is the IT backbone of global aviation — the systems behind
                passenger processing, baggage, airline operations, and airport
                connectivity for most of the world's airlines and airports. Our
                founders spent years managing enterprise IT within that
                environment.
              </p>
              <p className="text-gray-400">
                That experience means when we train aviation teams on AI, we
                understand your terminology, your operational constraints, your
                compliance culture, and your appetite for change. No translation
                required.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-white mb-4">
          AI Use Cases for Aviation Teams
        </h2>
        <p className="text-gray-400 mb-10 max-w-2xl">
          Real workflows, real tools, trained by someone who understands
          aviation operations.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              topics: [
                "AI strategy for airports and airlines",
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="bg-gradient-to-r from-brand/20 to-orange-400/10 border border-brand/30 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Train Your Aviation Teams on AI
          </h2>
          <p className="text-gray-300 mb-8 max-w-xl mx-auto">
            Whether you're an airport operator, airline, or aviation services
            company — we'll design the right programme for your teams.
          </p>
          <Link
            href="/contact"
