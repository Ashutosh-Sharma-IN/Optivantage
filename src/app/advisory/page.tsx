...
const TIERS = [
  {
    ...
    priceRange: "₹7L – ₹12L",
    tagline:
      "Understand where you are before committing to where you're going.",
    outcomes: [
  ...
  },
  {
    ...
    priceRange: "₹20L – ₹35L",
    tagline:
      "A vendor-evaluated, implementation-ready AI strategy built for your organisation.",
    outcomes: [
  ...
  },
  {
    ...
    tagline:
      "Sustained strategic guidance from someone who's built this from inside large enterprises.",
    outcomes: [
    ...
    includes: [
      ...
      "Priority access to our founder's direct calendar",
      ...
      <section className="py-20 px-4 bg-navy-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-text-muted mb-8 max-w-2xl mx-auto leading-relaxed">
            ...
            draws on 25 years of telecom and IT operations experience —
            including 7 years in senior director roles at one of the world's
            largest telcos.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Industries where AI meets complex operations, regulatory constraints, and large workforces. Our founder speaks your language.",
              },
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-text-muted leading-relaxed mb-4 text-sm">
                  Most "AI adoption" services either sell you software or give
                  you recorded videos. This is different: direct access to
                  someone who has run 1,000+ person operations, saved 2,400
                  hours/month through ML automation at BT, and trained 1,000+
                  professionals on AI tools.
                </p>
                <p className="text-text-muted leading-relaxed text-sm">
                  Our founder personally delivers every engagement. No junior
                  consultants. No generic decks.
                </p>
              </div>
              <div className="space-y-4">
                {[
                  ...
                  {
                    label: "ML automation built at BT",
                    value: "2,400 hrs/mo saved",
                  },
                  {
                    label: "Certifications",
                    value: "ISO 42001 · UT Austin AI",
                  },
                ].map(({ label, value }) => (
                  <div
                    key={label}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted max-w-xl mx-auto">
              Each tier builds on the previous. Most clients start with a
              Snapshot or Roadmap and transition to the Advisory Retainer once
              they see the value.
            </p>
          </div>
          ...
          <p className="text-center text-text-muted text-xs mt-6">
            Prices shown in INR. USD pricing available for international
            clients. All engagements start with a free 30–45 minute introductory
            call.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 bg-navy-800 border border-white/10 rounded-2xl p-8">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-2">
                Our Founding Team — Optivantage Technologies
              </h3>
              <p className="text-text-muted text-sm leading-relaxed">
                25 years in telecom and IT operations across BT, Telstra,
                Orange, SITA. Former Director, Service Operations at BT managing
                1,000+ FTEs. AI certified trainer (Microsoft Copilot, Azure AI,
                Google AI), ISO 42001 certified, UT Austin AI for Leaders
                postgraduate. Clients include Hexaware, Infogain, Kotak Mahindra
                Bank.
              </p>
      ...
      <section className="py-16 px-4 bg-brand">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/80 mb-8">
            Take our 5-minute AI Readiness Assessment. You'll get a personalised
            score, three specific insights about your organisation, and a clear
            recommended next step. No email required to begin.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/ai-ready"
