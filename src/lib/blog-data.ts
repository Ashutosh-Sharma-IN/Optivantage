export type BlogCategory = 'AI Training & Advisory' | 'IT Infrastructure' | 'IT Equipment & Rentals' | 'AI Automation & Agentic AI' | 'General';
...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "India doubled its AI training output last year. The skills gap widened anyway. The problem is not the volume of training — it is what the training is designed to do.",
  ...
  },
  {
    ...
    excerpt: "Microsoft Copilot licences are being purchased by enterprises across India at pace. Most of them are not being used three months in. The reason is not the tool — it is how the rollout was done.",
    category: "AI Training & Advisory",
    date: "2026-04-29",
    readTime: "5 min read",
    author: "Ashutosh Sharma",
  ...
  },
  {
    ...
    excerpt: "Most people prompt Copilot the way they type into a search bar — a few words and a hope. The CRAFT framework is a five-step structure that consistently produces output worth using.",
    category: "AI Training & Advisory",
    date: "2026-05-08",
    readTime: "5 min read",
    author: "Ashutosh Sharma",
  ...
  },
  {
    ...
    excerpt: "KPMG just got ISO 42001 certified. India's IT heads are fast-tracking their own governance programmes. Most of them could not answer basic questions about what the standard actually requires.",
    category: "AI Training & Advisory",
    date: "2026-04-27",
    readTime: "7 min read",
    author: "Ashutosh Sharma",
  ...
  },
  {
    ...
    title: "GCC Expansion in India: Why Your Network Matters More Than Your AI Licence",
    excerpt: "India added a record 31 million square feet of GCC space in 2025. A lot of that space is running AI workloads on infrastructure that was not designed for them. That gap is where AI deployments quietly fail.",
