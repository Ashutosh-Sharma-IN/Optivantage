...
export default function SampleReportForm() {
    ...
    return (
      <div className="bg-green-900/20 border border-green-700/30 rounded-xl p-8 text-center">
        ...
        <p className="text-text-muted">
          We will review your details and send a sample report within 2 business days.
          If we need anything else, we will reach out directly.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <label className={labelClass}>
          What service does your company sell? <span className="text-red-400">*</span>
        </label>
        <input
          type="text"
        ...
        <p className="text-xs text-text-muted mt-2">
          This helps us tune the hiring signals to match your actual service offering.
        </p>
      </div>
